...
document.querySelector('#app').innerHTML = `
  <div class="p-6 bg-gray-50 min-h-screen flex items-start justify-center">
    <div class="w-full max-w-xl space-y-6">
      <h1 class="text-3xl font-extrabold text-gray-900">Prueba Tailwind</h1>
      <p class="text-gray-600">Elementos simples para comprobar estilos de TailwindCSS.</p>
      <div class="flex items-center gap-4">
        <button class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">
          Botón primario
        </button>
        <button class="bg-transparent hover:bg-blue-100 text-blue-700 font-medium py-2 px-4 border border-blue-200 rounded">
          Botón secundario
        </button>
      ...
      <input class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Campo de texto" />
